...
CREATE TABLE seller_profiles (
                                 ...
                                 payout_preference ENUM('BANK', 'EWALLET', 'CARD', 'MANUAL') NOT NULL DEFAULT 'MANUAL',
                                 created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                 updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE payment_accounts (
                                  id BIGINT AUTO_INCREMENT PRIMARY KEY,
                                  user_id VARCHAR(36) NOT NULL,
                                  account_type ENUM('BANK', 'EWALLET', 'CARD') NOT NULL,
...
CREATE TABLE auctions (
                          ...
                          anti_sniping_window_seconds INT NOT NULL DEFAULT 10,
...
CREATE TABLE payouts (
                         ...
                         CONSTRAINT fk_payouts_account
                             FOREIGN KEY (payout_account_id) REFERENCES payment_accounts(id),
...
CREATE TABLE wallet_transactions (
                                     ...
                                     transaction_type ENUM('TOP_UP', 'BID_HOLD', 'BID_RELEASE', 'PAYMENT', 'REFUND', 'ADJUSTMENT') NOT NULL,
                                     amount DECIMAL(15, 2) NOT NULL,
                                     balance_before DECIMAL(15, 2) NOT NULL,
                                     balance_after DECIMAL(15, 2) NOT NULL,
                                     note VARCHAR(255) NULL,
                                     created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
                                     CONSTRAINT fk_wallet_transactions_bidder
                                         FOREIGN KEY (bidder_id) REFERENCES users(id),
                                     CONSTRAINT fk_wallet_transactions_auction
                                         FOREIGN KEY (auction_id) REFERENCES auctions(id),
...
CREATE INDEX idx_wallet_transactions_bidder_time
    ON wallet_transactions (bidder_id, created_at DESC);
